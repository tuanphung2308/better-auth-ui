...
<div className="flex -mt-8 -mb-4">
    <Image src="/better-auth-ui-promo-dark.png" width="2000" height="1338" alt="better-auth-ui" className="hidden dark:block" />
    <Image src="/better-auth-ui-promo-light.png" width="2000" height="1338" alt="better-auth-ui" className="dark:hidden" />
</div>
