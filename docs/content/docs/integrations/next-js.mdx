...
Want to skip the installation? Clone out the starter here:

### App Router

[GitHub](https://github.com/daveyplate/better-auth-nextjs-starter) - [Demo](https://better-auth-nextjs-starter.vercel.app)
