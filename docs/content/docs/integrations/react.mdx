...
This guide covers integrating `@daveyplate/better-auth-ui` into your React project using generic React, with support for all features available in Next.js integrations.

## Getting Started

Follow these steps to integrate `@daveyplate/better-auth-ui` seamlessly into your React app:
