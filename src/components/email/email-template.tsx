            ...
            <Tailwind>
                <Body className={cn("my-auto mx-auto font-sans px-2", classNames?.body)}>
                    <Container className="border border-solid border-color rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
                        ...
                        <Heading className={cn("text-[24px] font-bold text-center p-0 my-[30px] mx-0", classNames?.heading)}>
                            {heading}
                        </Heading>
                        ...
                        <Section className="text-center mt-[32px] mb-[32px]">
                            <Button
                                className={cn("action-button rounded text-[12px] font-semibold no-underline text-center px-5 py-3", classNames?.button)}
                                href={url}
                            >
                                {action}
                            </Button>
                        ...
                        <Hr className={cn("border border-solid border-color my-[26px] mx-0 w-full", classNames?.hr)} />
